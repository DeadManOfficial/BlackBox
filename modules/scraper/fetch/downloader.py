...
class AdaptiveDownloader:
    ...
    async def _fetch_with_curl_cffi(
        ...
        try:
            ...
            from ..stealth.fingerprint import FingerprintSpoofer
            from ..stealth.headers import HeaderGenerator
    ...
    async def _fetch_with_nodriver(
        ...
        try:
            ...
            from ..stealth.injector import StealthInjector
    ...
    async def _fetch_with_chromedriver(
        ...
        try:
            ...
            from ..stealth.behavior import BehavioralSimulator
            from ..stealth.injector import StealthInjector
